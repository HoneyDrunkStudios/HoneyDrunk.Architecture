<#
.SYNOPSIS
    Files work items from an initiative folder into their target repos
    and populates The Hive project board fields from packet frontmatter.

.PARAMETER InitiativeFolder
    Path to the initiative folder under generated/work-items/active/.
...
.EXAMPLE
    .\scripts\file-work-items.ps1 -InitiativeFolder "generated/work-items/active/adr-0005-0006-rollout" -WaveFilter 1
#>
