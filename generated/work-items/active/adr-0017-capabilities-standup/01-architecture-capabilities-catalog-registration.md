...
The ADR file is **not** edited in this work-item:
...
> **Sync (2026-MM-DD):** Initiative scoped today. Packets 01-03 ready to file in Wave 1/2; packet 04 (Capabilities scaffold) parked on packets 02 + 03 landing — packet 02 because the scaffold body cites assigned invariant numbers, packet 03 because the repo must exist before file-work-items.sh can target it.
```
...
## Dependencies
None. This packet is the foundation of the initiative — it can land before the scaffold packet exists, because the catalog surface is design-decided already in ADR-0017. Packets 02, 03, and 04 reference this one as `work-item:01`.
