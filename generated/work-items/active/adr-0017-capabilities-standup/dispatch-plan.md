...
Packet 03 is human-only and gates packet 04 because the repo it creates is the target repo of packet 04 — `file-work-items.sh` cannot file an issue against a repo that does not exist yet.
...
This is the same pattern ADR-0016's standup initiative followed (`generated/work-items/active/adr-0016-honeydrunk-ai-standup/dispatch-plan.md` lines 71-115).
