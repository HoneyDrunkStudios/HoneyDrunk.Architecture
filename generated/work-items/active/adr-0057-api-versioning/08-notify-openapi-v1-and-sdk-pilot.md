...
dependencies: ["work-item:00", "work-item:01", "work-item:03", "work-item:04", "work-item:05", "work-item:07"]
adrs: ["ADR-0057"]
wave: 4
...
- `work-item:03` — `job-openapi-diff.yml`.
- `work-item:04` — `job-publish-public-sdk.yml`.
- `work-item:05` — `job-publish-docs.yml`.
- `work-item:07` — Web.Rest 0.6.0 (cursor primitives + RFC 7807 middleware + rate-limit-header hook).
