...
**Dependencies:**
- `work-item:00` — ADR-0050 Accepted; the two new tenant-lifecycle invariants (claimed as `67`/`68` from `constitution/invariant-reservations.md` by packet 00) live before the value types reference them.
