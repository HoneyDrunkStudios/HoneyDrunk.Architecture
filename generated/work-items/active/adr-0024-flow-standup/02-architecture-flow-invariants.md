...
In `generated/work-items/active/adr-0024-flow-standup/03-flow-node-scaffold.md`:
...
(Line numbers are as of this packet's authoring; re-run `rg -n "invariant 7[4-9]|invariant 8[0-2]|default 7[4-9]|default 8[0-2]" generated/work-items/active/adr-0024-flow-standup/03-flow-node-scaffold.md` immediately before editing to pick up any drift.)
...
- `generated/work-items/active/adr-0024-flow-standup/03-flow-node-scaffold.md` (only on shift)
- `CHANGELOG.md`
