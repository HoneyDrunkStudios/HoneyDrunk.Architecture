...
- `work-item:00` — packet 00's acceptance-tracking marker on the ADR file should land first so this packet's CHANGELOG entry references a consistent state.
