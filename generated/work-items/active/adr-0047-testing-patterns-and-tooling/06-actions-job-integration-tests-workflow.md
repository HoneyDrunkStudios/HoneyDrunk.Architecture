...
**Dependencies:**
- work-item:00 — ADR-0047 acceptance (so D-decision references are live rules).
- work-item:01 — the shared test-stack props fragment exists (Nodes consuming it produce `*.Tests.Integration` projects the job discovers).
