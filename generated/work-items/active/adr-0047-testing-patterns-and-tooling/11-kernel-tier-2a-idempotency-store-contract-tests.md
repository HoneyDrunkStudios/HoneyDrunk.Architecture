...
dependencies: ["work-item:01", "work-item:06", "work-item:07"]
...
- work-item:06 — `job-integration-tests.yml` picks up the Tier 2a project.
...
**Dependencies:**
- work-item:01 — the shared test-stack props fragment.
- work-item:06 — `job-integration-tests.yml` discovers the Tier 2a project.
- work-item:07 — the integration-test scaffold template.
