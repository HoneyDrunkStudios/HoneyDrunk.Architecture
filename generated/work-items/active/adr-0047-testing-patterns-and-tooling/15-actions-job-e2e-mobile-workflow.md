...
**Dependencies:**
- work-item:13 — `job-e2e-web.yml` establishes the E2E reusable-workflow pattern (trigger guard, failure-artifact upload) this mirrors.
