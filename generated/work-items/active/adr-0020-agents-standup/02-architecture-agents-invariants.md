...
4. **If ADR-0021 Knowledge has landed first and consumed 55-59**, shift further to 58-64 or whatever next seven free integers are available above the new high-water mark, and update lockstep:
   ...
   - `generated/work-items/active/adr-0020-agents-standup/03-agents-node-scaffold.md` — `rg -n '\b5[1-7]\b' …` each match in the default-naming convention, replace with assigned number. Pre-filing carve-out under invariant 24 applies.
...
- `generated/work-items/active/adr-0020-agents-standup/03-agents-node-scaffold.md` (only on shift)
- `CHANGELOG.md`
