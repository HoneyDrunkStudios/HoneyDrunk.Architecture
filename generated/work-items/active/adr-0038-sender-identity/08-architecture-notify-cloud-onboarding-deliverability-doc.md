...
**Dependencies:**
- `work-item:00` — soft. ADR-0038 should be Accepted first.
- `work-item:02` — soft. The SMS provider pick (10DLC registration goes through the chosen provider) and the ESP pick (DKIM delegation) shape the doc's concrete steps.
