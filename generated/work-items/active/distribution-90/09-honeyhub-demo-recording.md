...
## Dependencies
- `work-item:06` — the launch-blocking stack must be merged so the demo shows the real shipping build. (Recording may run in parallel with packet 08's docs work; re-record only if 08 visibly changes the UX.)
