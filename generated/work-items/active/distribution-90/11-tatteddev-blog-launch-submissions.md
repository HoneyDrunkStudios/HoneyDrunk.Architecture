...
dependencies: ["work-item:05", "work-item:08", "work-item:10"]
adrs: ["PDR-0011"]
source: human
generator: scope
wave: 4
...
## Dependencies
- `work-item:05` — the waitlist must be live before traffic is driven (PDR-0011 §5's probe needs the funnel connected).
- `work-item:08` — the release must exist.
- `work-item:10` — the launch post must be published.
