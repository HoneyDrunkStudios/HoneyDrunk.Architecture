...
**Dependencies:**
- `work-item:02` — hard. The artifact's section 9 (open mitigations) is populated; this packet keeps the two surfaces consistent.
- `work-item:03` — soft. The standup-template + hive-sync extension is in place; future AI-sector standups and Audit Phase-2 work will be readable against both surfaces.
