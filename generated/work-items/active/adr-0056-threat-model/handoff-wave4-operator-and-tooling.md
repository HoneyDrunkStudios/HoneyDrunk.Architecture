...
- Scaffolded `job-cve-to-packet.yml` reusable workflow consuming Dependabot alerts and authoring critical-severity packets via `file-work-items.yml`.
...
- **Critical-only auto-create in packet 08.** High / Medium / Low severities ride Dependabot's standard PR flow without packet creation. Critical alone gets the auto-work-item. ADR-0056 D7 is explicit.
