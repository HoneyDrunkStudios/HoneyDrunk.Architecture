...
2. **Was there a mitigation that was on paper but not actually in place?** If yes, the amendment moves the mitigation from "shipped" to "open" in the artifact's section 9, and adds an work item to actually ship it.
...
**Dependencies:**
- `work-item:00` — soft. ADR-0056 should be Accepted before its operator-facing runbook lands.
