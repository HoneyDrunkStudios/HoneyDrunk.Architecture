...
**Dependencies:**
- `work-item:00` — initiative registered so this packet has a known initiative anchor.
- `work-item:01` — invariants 82/83/84 live in `constitution/invariants.md` before the agents reference D5/D6/D7 as canonical caching rules.
