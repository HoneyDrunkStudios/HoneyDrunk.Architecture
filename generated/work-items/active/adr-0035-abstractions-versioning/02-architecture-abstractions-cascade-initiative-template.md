...
**ADR-0008 D10 — Initiative slug convention.** Generated artifacts live under `generated/work-items/active/` grouped by initiative; the initiative slug follows `adr-NNNN-<kebab>`. The cascade variant of this convention is what D7 invokes.
...
**Dependencies:**
- `work-item:00` — ADR-0035 acceptance (soft — references ADR-0035 D7 as a live rule).
