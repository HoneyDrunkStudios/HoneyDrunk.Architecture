...
**Dependencies:**
- `work-item:00` — ADR-0048 must be Accepted so the schema-on-read policy is a live rule.
- `work-item:06` — the canonical `Migrations/README.md` template is the structural reference. If 06 hasn't merged, the executor reads ADR-0048 D7 and D11 directly.
