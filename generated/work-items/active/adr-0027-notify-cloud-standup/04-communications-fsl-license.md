...
## Dependencies
- `work-item:01` — packet 01 lands the new constitution language and context-folder content that references FSL. Filing 04 before 01 would mean the FSL commit lands without a constitutional anchor describing why.
