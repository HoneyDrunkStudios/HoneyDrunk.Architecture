...
**Dependencies:**
- `work-item:00` — ADR-0073 Accepted (the D3 amendment to channel-scoped naming is in the ADR text when this packet runs).
- `work-item:01` — Notify solution at `0.3.1` (this packet bumps from there to `0.4.0`).
