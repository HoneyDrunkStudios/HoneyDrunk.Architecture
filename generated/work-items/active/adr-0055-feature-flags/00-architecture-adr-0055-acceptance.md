...
4. Add a new row to the **Active Reservations** table in `constitution/invariant-reservations.md` claiming that block for ADR-0055. Row shape: `<NA>-<NB> | ADR-0055 | Proposed | Feature-flag substrate (`{N-FLAG-GATE}`, `{N-FLAG-NAMING}`). Packet 00 at `generated/work-items/active/adr-0055-feature-flags/00-architecture-adr-0055-acceptance.md`.`
