...
- `work-item:00` — ADR-0078 acceptance + invariants 93/94. This doc references invariant 94 by number.
- `work-item:01` — Catalog updates. This doc cross-links to the Identity context-file amendments and the `notes:` field text in `contracts.json`.
