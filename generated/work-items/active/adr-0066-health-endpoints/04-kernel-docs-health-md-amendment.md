...
**Dependencies:**
- `work-item:03` — the runtime code (`MapHoneyDrunkHealthEndpoints`, the Functions-host helper, the aggregator) must be on the branch before the docs reference it.
