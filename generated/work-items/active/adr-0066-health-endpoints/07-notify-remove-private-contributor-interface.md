...
**Dependencies:**
- `work-item:06` — the bridge adapter, the `[Obsolete]` marking, and the host registration via the adapter were introduced. The deprecation window between packet 06 and this packet is honoured (default 60 days per ADR-0035 minimum, or document a tighter window in the PR).
