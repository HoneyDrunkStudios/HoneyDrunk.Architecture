...
- [ ] Each checklist item that maps to a numbered invariant (8, 78, 79, 80, 81) cites the invariant inline — the executor reading the prompt does not have to follow the citation; the rule text is right there (the self-containment rule for agent prompts is the same as for work items)
...
**Dependencies:**
- `work-item:00` — ADR-0062 Accepted and its invariants (78, 79, 80, 81) live before the review prompts cite them.
