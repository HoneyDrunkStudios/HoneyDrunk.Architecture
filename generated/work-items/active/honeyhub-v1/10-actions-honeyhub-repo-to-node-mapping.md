...
## Dependencies
- `work-item:02` — the `HoneyDrunk.HoneyHub` GitHub repo must exist before the repo-to-node mapping is meaningful. This packet runs in parallel with packet 03 once packet 02 is Done.
