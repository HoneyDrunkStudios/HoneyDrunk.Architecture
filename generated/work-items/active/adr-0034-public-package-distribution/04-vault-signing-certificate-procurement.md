...
**Dependencies:**
- `work-item:03` — `job-publish-nuget.yml` (hard — the workflow with the conditional sign stage must exist; this packet provisions the certificate that activates it).
