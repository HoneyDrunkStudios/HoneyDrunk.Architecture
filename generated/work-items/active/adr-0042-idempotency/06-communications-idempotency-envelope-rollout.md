...
**Dependencies:**
- `work-item:04` — `IdempotentMessageHandler<T>`, `IGridMessagePublisher` in `HoneyDrunk.Kernel` `0.8.0`.
- (Soft) `work-item:03` — Cosmos `IIdempotencyStore` for deployed composition, InMemory for tests.
