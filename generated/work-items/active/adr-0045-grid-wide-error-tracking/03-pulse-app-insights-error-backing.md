...
dependencies: ["work-item:02", "Architecture#ADR0040-PACKET05"]
...
**Dependencies:**
- `work-item:02` — hard. This packet implements the `IErrorReporter` facade packet 02 added.
