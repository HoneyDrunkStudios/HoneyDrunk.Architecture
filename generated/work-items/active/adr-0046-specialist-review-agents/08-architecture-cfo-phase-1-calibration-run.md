...
dependencies: ["work-item:03", "work-item:04", "work-item:05", "work-item:06", "work-item:07"]
...
## Affected Files
- A calibration note — `generated/post-merge-audits/cfo-phase-1-calibration.md` or `generated/work-items/active/adr-0046-specialist-review-agents/cfo-phase-1-calibration.md` (execution agent chooses per convention).
...
## Dependencies
- `work-item:03` — `cfo.md` must exist before it can be invoked.
- `work-item:04`, `work-item:05`, `work-item:06`, `work-item:07` — all five specialist definition files must exist before this packet's consolidated capability-matrix row-flip can mark the full roster "live." The calibration itself only needs `cfo` (packet 03), but the matrix flip needs all five.
...
**Dependencies:**
- `work-item:03` — `cfo.md` must exist (calibration target agent).
- `work-item:04`, `work-item:05`, `work-item:06`, `work-item:07` — all five definition files must exist before the consolidated matrix flip.
