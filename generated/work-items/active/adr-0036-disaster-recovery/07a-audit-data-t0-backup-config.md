...
**Dependencies:**
- `work-item:06` — hard. The Audit runbook must exist so the live config can be checked against its backing-inventory section. No dependency on the Vault drill — this is the config step, not the drill.
