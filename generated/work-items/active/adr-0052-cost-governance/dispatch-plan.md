...
**Before pushing:** there are no cross-initiative `Architecture#<n>` placeholders in this initiative — every `dependencies:` array uses `work-item:NN` (within-folder) edges only. Safe to push as soon as the packets are written.
