...
**Dependencies:**
- `work-item:03` — the Kernel contract surface (Kernel `0.9.0` or whichever version packet 03 lands at) must exist on the NuGet feed (gated by the human release-tag step on `HoneyDrunk.Kernel` after packet 03 merges).
