...
**Dependencies:**
- `work-item:02` — `business/context/cost-budgets.json` exists and is the canonical source.
- `work-item:04` — `HoneyDrunk.AI.Abstractions` is reconciled against the Kernel contract; the stub `DefaultCostLedger` exists for this packet to replace.
