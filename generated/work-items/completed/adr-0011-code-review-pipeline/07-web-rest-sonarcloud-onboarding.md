...
> **Invariant 32:** Agent-authored PRs must link to their packet in the PR body. *(The PR opened by this packet must include the `> Work Item: <permalink>` line per packet 03's mechanism.)*
