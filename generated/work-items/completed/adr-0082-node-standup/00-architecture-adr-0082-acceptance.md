...
- **PR body metadata.** Every PR body must include strict `Authorship: <enum>` plus exactly one of `Work Item:` (pointing at this packet path) or `Out-of-band reason:` — free-form text breaks pr-core checks.
