...
dependencies: ["work-item:18", "work-item:13", "work-item:14"]
...
- `work-item:13` — the modules the skeleton references exist.
- `work-item:14` — the `platform/` exported IDs the skeleton references exist.
