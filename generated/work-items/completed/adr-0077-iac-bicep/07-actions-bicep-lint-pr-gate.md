...
**Dependencies:**
- `work-item:03` — `bicep/bicepconfig.json` exists so the linter has rules to apply. The reusable workflow itself does not depend on the modules existing; it lint any Bicep file the PR touches.
