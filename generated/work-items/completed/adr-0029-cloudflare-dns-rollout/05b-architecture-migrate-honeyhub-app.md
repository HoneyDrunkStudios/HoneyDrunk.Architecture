...
Follow [`infrastructure/cloudflare-domain-transfer.md`](../../../../infrastructure/cloudflare-domain-transfer.md) end-to-end for the apex `honeyhub.app`. Domain-specific specifics for this work-item:
...
- `work-item:04` — `honeydrunkstudios.com` cutover. P4 validates the transfer flow on the lowest-risk domain. P5b should not execute until P4 is verified-clean. This is the Wave 2 → Wave 3 boundary.
