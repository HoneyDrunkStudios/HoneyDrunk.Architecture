...
dependencies: ["work-item:04", "work-item:05"]
...
## Dependencies
- `work-item:04` — the bridge core + the `AgentBackendAdapter` trait this adapter implements.
- `work-item:05` — pairing + the workspace-root/backend allowlist must gate launches before a real CLI is driven.
