...
dependencies: ["work-item:06", "work-item:07"]
...
## Dependencies
- `work-item:06` — the Claude Code adapter must drive a real session for the run screen to exercise.
- `work-item:07` — the local store + notifications the run screen reads (session list, usage, notification surfacing).
