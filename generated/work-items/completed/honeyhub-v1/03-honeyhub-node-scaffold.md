...
The **hive-field mirror is central** (driven by `file-work-items.yml` + the refresh workflow on The Hive project) — no per-repo mirror workflow is needed for HoneyHub.
