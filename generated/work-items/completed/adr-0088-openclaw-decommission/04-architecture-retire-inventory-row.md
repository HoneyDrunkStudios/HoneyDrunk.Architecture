...
## Dependencies
- `work-item:03` — secret deletion + #527 closure (**hard, invariant-103 gate** — the inventory triplet retires only after the secret is confirmed deleted).
...
**Dependencies:**
- `work-item:03` — secret deletion + #527 closure (hard, invariant-103 gate).
