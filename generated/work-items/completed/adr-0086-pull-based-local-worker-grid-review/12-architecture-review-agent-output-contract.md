...
dependencies: ["work-item:03", "work-item:07"]
...
## Dependencies
- `work-item:03` — runner framework and synthesis path.
- `work-item:07` — Architecture local-worker cutover evidence that exposed the PR-facing output-contract mismatch.
