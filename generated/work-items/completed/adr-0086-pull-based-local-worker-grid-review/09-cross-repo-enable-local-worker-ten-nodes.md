...
dependencies: ["work-item:07", "work-item:08"]
...
## Dependencies
- `work-item:07` — Phase-A cutover (**hard** — Phase B does not start until Phase A is green).
- `work-item:08` — OpenClaw decommission (**hard** — ADR-0086 D10 sequences the decommission before Phase B begins).
...
**Dependencies:**
- `work-item:07` (hard), `work-item:08` (hard).
