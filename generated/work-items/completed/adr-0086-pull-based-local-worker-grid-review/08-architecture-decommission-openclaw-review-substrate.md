...
## Dependencies
- `work-item:07` — Phase-A cutover (**hard** — ADR-0086 D10 is explicit that decommission happens at Phase A → Phase B cutover, not before).
...
**Dependencies:**
- `work-item:07` — Phase-A cutover (hard).
