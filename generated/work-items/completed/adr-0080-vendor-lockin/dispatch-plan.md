...
No cross-initiative `{Repo}#N` dependencies to substitute — every dependency in this initiative is a `work-item:NN` reference, all of which resolve within this folder once filed.
