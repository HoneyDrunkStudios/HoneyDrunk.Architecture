...
**Dependencies:**
- work-item:01 — the shared test-stack props fragment declares `NSubstitute`. Sequence after 01. No dependency on other per-Node Moq-migration issues — they are mutually independent and may run in parallel.
