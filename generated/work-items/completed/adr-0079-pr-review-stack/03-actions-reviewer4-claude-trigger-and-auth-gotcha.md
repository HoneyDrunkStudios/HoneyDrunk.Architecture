...
**Dependencies:**
- `work-item:00` — hard. Reviewer 4's invariant backing (`{N1}`, `{N3}`, `{N4}`) lands in packet 00.
- `work-item:02` — hard. The `is_substantive` output the gate consumes is packet 02's deliverable.
