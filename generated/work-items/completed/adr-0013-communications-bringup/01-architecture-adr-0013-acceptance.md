...
**ADR-0008 (Work item conventions):**
- **§D10:** Generated artifacts under `/generated/work-items/active/{initiative-slug}/` co-located with dispatch plan and handoffs. Archived as a single folder move when Done.
