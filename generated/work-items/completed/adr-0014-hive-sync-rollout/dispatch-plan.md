...
gh issue create --repo HoneyDrunkStudios/HoneyDrunk.Architecture \
  ...
  --body-file "generated/work-items/active/adr-0014-hive-sync-rollout/01-architecture-rename-to-hive-sync.md" \
...
gh issue create --repo HoneyDrunkStudios/HoneyDrunk.Architecture \
  ...
  --body-file "generated/work-items/active/adr-0014-hive-sync-rollout/02-architecture-packet-lifecycle.md" \
...
gh issue create --repo HoneyDrunkStudios/HoneyDrunk.Architecture \
  ...
  --body-file "generated/work-items/active/adr-0014-hive-sync-rollout/03-architecture-board-items-tracking.md" \
...
gh issue create --repo HoneyDrunkStudios/HoneyDrunk.Architecture \
  ...
  --body-file "generated/work-items/active/adr-0014-hive-sync-rollout/04-architecture-proposed-adrs-queue.md" \
...
gh issue create --repo HoneyDrunkStudios/HoneyDrunk.Architecture \
  ...
  --body-file "generated/work-items/active/adr-0014-hive-sync-rollout/05-architecture-adr-pdr-auto-acceptance.md" \
...
gh issue create --repo HoneyDrunkStudios/HoneyDrunk.Architecture \
  ...
  --body-file "generated/work-items/active/adr-0014-hive-sync-rollout/06-architecture-drift-detection.md" \
