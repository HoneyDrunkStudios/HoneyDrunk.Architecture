...
## Dependencies
- `work-item:01` — ADR-0044 acceptance (soft; references ADR-0044 decisions as live rules).
- `work-item:02` — GitHub App + Anthropic key in Vault (**hard** — the workflow cannot authenticate the cross-repo checkout or call the API without these credentials).
...
- `work-item:02` — GitHub App + Anthropic key in Vault (hard).
