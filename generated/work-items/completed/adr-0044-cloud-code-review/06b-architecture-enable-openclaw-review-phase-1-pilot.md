...
dependencies: ["work-item:02b", "work-item:03b", "work-item:04", "work-item:05b"]
adrs: ["ADR-0044", "ADR-0011"]
accepts: ["ADR-0044"]
wave: 1
initiative: adr-0044-cloud-code-review
node: honeydrunk-architecture
supersedes: ["work-item:06"]
---
...
## Dependencies
- `work-item:02b` — OpenClaw runner runtime definition (hard)
- `work-item:03b` — `job-review-request.yml` trigger rail (hard)
- `work-item:04` — review rubric in `review.md` (hard)
- `work-item:05b` — OpenClaw-aware review config schema doc (soft)
