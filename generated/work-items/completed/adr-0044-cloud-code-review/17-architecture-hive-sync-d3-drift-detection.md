...
dependencies: ["work-item:04", "work-item:09"]
...
## Dependencies
- `work-item:04` — `review.md` rubric (**hard** — the drift check compares against the rubric authored there).
- `work-item:09` — upstream agent D3 sections (**hard** — the drift check compares against the category-subset sections authored there).
...
- `work-item:09` — upstream agent D3 sections (hard).
