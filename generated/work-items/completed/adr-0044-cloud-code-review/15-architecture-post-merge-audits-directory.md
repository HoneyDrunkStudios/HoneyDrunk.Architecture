...
Match the format of other `generated/` subdirectory READMEs (e.g. `generated/incidents/`, `generated/work-items/`) for consistency.
...
## Dependencies
- `work-item:01` — ADR-0044 acceptance (soft; D9 is a live binding once ADR-0044 is Accepted).
