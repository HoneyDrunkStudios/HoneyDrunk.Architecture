# ADR-DRAFT: HoneyHub Local Runner Bridge for Agent Cockpit Sessions

**Status:** Draft
**Date:** 2026-06-06
**Deciders:** HoneyDrunk Studios
**Sector:** Meta / AI / Platform
**Follows from:** PDR-DRAFT Agent Cockpit and Usage Governance, PDR-0009, ADR-0003, ADR-0086
...
This ADR draft decides the bridge boundary and session contract. It does not decide the final hosted HoneyHub app stack, UI framework, or cloud/API dispatch provider.
...
|---|---|---|
| Does the first bridge live inside an existing HoneyHub repo, a new repo, or an ADR-0086 runner package? | Architecture | Open |
| What is the minimum supported remote-control path for mobile: same LAN, Tailscale, cloud relay, or hosted HoneyHub tunnel? | Architecture / Ops | Open |
| Which Codex and Claude Code interfaces are stable enough for v1 adapters? | Architecture / Product | Open |
| How much transcript content should team dashboards store versus summarize? | Product / Security | Open |
...
| What metadata, if any, should future team/org mode aggregate across users? | Product / Security | Open |
