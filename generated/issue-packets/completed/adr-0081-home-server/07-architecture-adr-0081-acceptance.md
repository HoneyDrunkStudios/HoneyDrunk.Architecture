...
dependencies: ["packet:01", "packet:02", "packet:03", "packet:04", "packet:05", "packet:06"]
adrs: ["ADR-0081"]
accepts: ["ADR-0081"]
wave: 2
...
## Dependencies
- packet:01 (hardware brief — Acceptance Criterion 1)
- packet:02 (OS + hardening — Acceptance Criterion 2)
- packet:03 (security checklist — Acceptance Criterion 5)
- packet:04 (tunnel + bridge migration plan — Acceptance Criterion 3)
- packet:05 (backup plan — Acceptance Criterion 4)
- packet:06 (migration runbook — referenced from acceptance evidence, not a gate)
...
```
Authorship: Human
Packet: generated/issue-packets/proposed/adr-0081-home-server/07-architecture-adr-0081-acceptance.md
```
