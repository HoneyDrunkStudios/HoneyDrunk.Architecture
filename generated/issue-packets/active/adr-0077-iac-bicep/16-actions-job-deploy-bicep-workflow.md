...
**Dependencies:**
- `packet:00` — ADR-0077 (amended) Accepted. (The workflow ships idle until `HoneyDrunk.Infrastructure` calls it; it does not need packets 13/14 to exist at author time.)
