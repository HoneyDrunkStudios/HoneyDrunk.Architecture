...
**No cross-initiative placeholders.** All `dependencies:` entries are `packet:NN` (same-folder) — none reference other initiatives or pre-filed issues. Safe to push as a single batch.
