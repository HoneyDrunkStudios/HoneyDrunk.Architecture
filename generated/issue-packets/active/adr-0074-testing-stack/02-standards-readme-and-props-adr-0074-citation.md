...
## Dependencies
- `packet:00` — ADR-0074 should be Accepted before its citation lands in the `HoneyDrunk.Standards` README, so the README cites an Accepted ADR.
...
**Dependencies:**
- `packet:00` — ADR-0074 should be Accepted before its citation lands in `HoneyDrunk.Standards`.
