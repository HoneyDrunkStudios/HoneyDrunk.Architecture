...
- [ ] `implementation-notes.md` exists in `generated/issue-packets/active/adr-0093-loop-engineering/` and covers all sections above.
...
**Key Files:**
- `generated/issue-packets/active/adr-0093-loop-engineering/implementation-notes.md` (new)
