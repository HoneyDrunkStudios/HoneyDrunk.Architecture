...
dependencies: ["packet:01", "packet:07", "packet:09", "packet:11"]
...
- packet:11 — the reusable contract test and Tier 2a InMemory binding; this packet binds the same reusable class to the Cosmos backing.
