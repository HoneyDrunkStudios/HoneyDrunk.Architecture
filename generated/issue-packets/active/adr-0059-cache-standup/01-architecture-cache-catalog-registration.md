...
Eight specific drift items must be resolved in this packet:
...
None. This packet is the foundation of the initiative — it can land before the scaffold packet exists, because the catalog surface is design-decided already in ADR-0059. Packets 02 and 03 reference this one as `packet:01`.
