...
**Dependencies:**
- `packet:05` — Communications has the workflow scaffold to extend.
- `packet:06` — Data has the export pipeline with its own audit emission (no overlap; named to confirm full Wave 4 has landed).
