...
## Dependencies
- `packet:03` — secret deletion (Architecture-repo packet; sequenced before this Actions cleanup per ADR-0088 D3 step 12).
...
**Dependencies:**
- `packet:03` — secret deletion (Architecture packet; sequenced before this cleanup).
