...
dependencies: ["packet:01", "packet:07", "packet:08"]
adrs: ["ADR-0049"]
wave: 5
...
**Dependencies:**
- `packet:01` — catalog schema and empty seed exist.
- `packet:07` — Core-sector backfill complete and released.
- `packet:08` — Ops-sector backfill complete and released.
