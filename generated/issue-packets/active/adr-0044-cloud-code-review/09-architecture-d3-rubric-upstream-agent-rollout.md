...
## Dependencies
- `packet:04` — `review.md` twenty-category rubric (**hard** — the upstream sections must reference the same category names/numbering authored in `review.md`; doing this packet first risks divergence).
