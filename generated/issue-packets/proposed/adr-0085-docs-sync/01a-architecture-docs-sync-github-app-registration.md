...
**Not in scope for this packet:** the walkthrough doc itself. That lives in packet 01b.
...
## Dependencies
- `packet:01` — soft. ADR-0085 must be Accepted (packet 01) so the App is provisioned against a clearly defined consumer.
...
**Dependencies:**
- `packet:01` — soft (ADR accepted before App is provisioned against a clearly defined consumer).
