...
- Architecture repo boundary: this repo owns ADRs, constitution files, routing rules, catalogs, generated issue packets, and agent workflow governance. Do not implement docs-sync runtime behavior in another repo under this packet.
