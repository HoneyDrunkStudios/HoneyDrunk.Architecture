...
ADR-0084 Follow-up Work names this packet: *"Phase 4 rollout — wire Azure budget alerts (ADR-0052) and App Insights internal-Grid error spikes (ADR-0045)."*
...
**Dependencies:** packet:05 (`job-discord-notify.yml` must exist). Packet:06 (`discord-notify.ps1`) is required for the home-server-relay path; same-wave so structurally satisfied.
