...
| [PDR-0007](PDR-0007-arcadia-city-quest-map-and-place-unlocks.md) | Arcadia: City Quest Map and Place Unlocks | Proposed | 2026-05-07 | Market / Location / AI / Play | Consumer city exploration app inspired by open-world question marks: users physically unlock nearby points of interest, micro-quests, context, and collectibles. Starts with one curated launch district; no UGC or global content in v1. |
