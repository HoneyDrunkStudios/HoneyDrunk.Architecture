...
- [ ] **ADR-0088 Decommission OpenClaw** — accept + tear down the dead OpenClaw reference surface (`infrastructure/openclaw/*`, ADR-0007 addendum, cross-ADR references, `OPENCLAW_GRID_REVIEW_WEBHOOK_SECRET`); supersedes ADR-0081 (home server decommissioned); ADR-0086 Phase B defers the physical/governance teardown here *(current-focus #2; packet cluster #539/#541/#545/#546 open)*
