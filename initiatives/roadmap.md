...
- [ ] **Hive Sync Rollout (ADR-0014) — in progress** *(rename the legacy initiative sync agent to hive-sync, move runtime to OpenClaw scheduled/manual execution, add packet lifecycle, board-items tracking, Proposed-ADR queue, ADR/PDR auto-acceptance, README sync, and drift detection)*
