...
- [x] **ADR-0082 Canonical Node Standup Procedure — deliverables completed 2026-05-29** — `adr-0082-node-standup`: ADR-0082 Accepted (PR #505); invariant 102 + `## Standup Procedure Invariants` section in `constitution/invariants.md`; `constitution/node-standup.md` (PR #508); all six `infrastructure/walkthroughs/` node-standup + org-secret-repo-binding walkthroughs (PR #510). *(Initiative not yet archived — 7 of 8 GitHub issues still need closing; see active-initiatives.md sync note.)*
