...
- `ADR-0065` — ADR-0065: Multi-Service Local Dev Orchestration and .NET Aspire Stance — 0/2 accepting packet issues closed; open: HoneyDrunk.Architecture#378, HoneyDrunk.Architecture#379
- `ADR-0066` — ADR-0066: Health, Readiness, and Liveness Endpoint Contract — 0/1 accepting packet issues closed; open: HoneyDrunk.Architecture#293
- `ADR-0067` — ADR-0067: Inbound Rate Limiting and Quota Enforcement — 0/1 accepting packet issues closed; open: HoneyDrunk.Architecture#310
