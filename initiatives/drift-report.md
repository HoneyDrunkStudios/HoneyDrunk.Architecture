...
- **Category 14: current-focus drift**
  - **Item:** ADR-0032 focus row still requires manual acceptance reconciliation
  - **First Surfaced:** 2026-06-10
  - **Detail:** ADR-0032 has all historical implementation packets closed but lacks `accepts:` frontmatter for auto-flip; `current-focus.md` is netrunner-owned.
- **Category 14: current-focus drift**
  - **Item:** ADR-0091/0092 focus text still calls them un-flipped
  - **First Surfaced:** 2026-06-10
  - **Detail:** `current-focus.md` says ADR-0091/0092 are conceptually accepted and only un-flipped, but both ADR frontmatter records are already Accepted; netrunner owns the file.
...
- **Category 17: implementation-notes completion-gate hold**
  ...
  - **First Surfaced:** 2026-06-08
  - **Detail:** governing decision lacks exact `## Implementation Notes (YYYY-MM-DD)` pointer heading. Hive-sync must hold this initiative In Progress until the implementing agent authors the conforming implementation-notes record.
- **Category 17: implementation-notes completion-gate hold**
  - **Item:** adr-0044-cloud-code-review
  - **First Surfaced:** 2026-06-08
  - **Detail:** packet-folder `implementation-notes.md` missing; governing decision lacks exact `## Implementation Notes (YYYY-MM-DD)` pointer heading. Hive-sync must hold this initiative In Progress until the implementing agent authors the conforming implementation-notes record.
- **Category 17: implementation-notes completion-gate hold**
