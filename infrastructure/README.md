...
These walkthroughs are the operational runbooks for ADR-0005, ADR-0006, and ADR-0015 rollout work. They are written for **Azure Portal first**; CLI is optional appendix material only.

## Walkthrough Index

Listed in provisioning order — platform-shared resources first, per-Node resources second.

**Platform-shared (provision once per environment):**
