...
2. Write `generated/scout-reports/{YYYY-MM-DD}.md`.
   ...
   - For each opportunity considered, use this labeled format:
     - **{opportunity title}**
       - Recommendation: {build/defer/drop/stay the course or concrete action}
       - Why: {core product or market signal}
