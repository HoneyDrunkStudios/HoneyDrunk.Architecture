...
Recorded per ADR-0008 § Implementation-Notes Packets. Full as-built record (every delta + rationale, PRs, follow-ups): [`generated/issue-packets/active/adr-0033-deploy-trigger-model/implementation-notes.md`](../generated/issue-packets/active/adr-0033-deploy-trigger-model/implementation-notes.md). The decision above is preserved as written; implementation refined it materially. Headline deltas (decided ➜ as-built):
