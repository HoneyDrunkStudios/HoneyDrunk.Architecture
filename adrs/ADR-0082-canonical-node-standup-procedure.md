...
**No new invariant.** This amendment adds a taxonomy row and class-specific steps; it does **not** add a `constitution/invariants.md` entry. Invariant 102's ten registration items still bind every Node of this class, with the `pr / build` check substituting for `pr-core / core` in clauses 8/9.
