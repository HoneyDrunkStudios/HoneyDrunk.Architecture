...
- **Agent sprawl risk.** The Grid has 11 custom agents today (per `.claude/agents/`). Adding specialists ad-hoc, without a pattern, produces a roster nobody can maintain and triggers nobody can predict. Codifying the pattern up front makes the roster legible.
