...
- **Consumer-app PDRs ([PDR-0003 Lately](../pdrs/PDR-0003-lately-currents-based-connection-app.md), [PDR-0005 Hearth](../pdrs/PDR-0005-hearth-personal-growth-as-a-living-town.md), [PDR-0006 Currents](../pdrs/PDR-0006-currents-social-suggestions-and-quests.md), [PDR-0007 Arcadia](../pdrs/PDR-0007-arcadia-city-quest-map-and-place-unlocks.md), [PDR-0008 Curiosities](../pdrs/PDR-0008-curiosities-discovery-first-city-app.md))** — every consumer-app PDR includes a paid tier or subscription price. Today there is no Grid-side place those prices live; tomorrow each consumer app invents a `decimal price` field with no currency code.
