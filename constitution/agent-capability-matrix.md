...
| **file-issues** | Packets ready to file as GitHub Issues | Work items from `generated/work-items/active/` | GitHub Issues in target repos (via gh CLI) | Edit packets post-filing, make decisions |
